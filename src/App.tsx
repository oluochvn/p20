...
function App(){
  ...
  return(
    ...
    <div className="">
<nav className={`relative md:pl-[20%] md:pr-[20%] flex justify-between md:sticky top-0 backdrop-blur-[7px] items-center border-b border-gray-700 h-[10vh] md:p-10 md:px-5`}>
